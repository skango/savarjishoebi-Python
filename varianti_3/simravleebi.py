...
def main():
    ...
    set1 = list_to_set(ELEMENTEBI_1)
    set2 = list_to_set(ELEMENTEBI_2)
    ...
    vitom_mudmiva = 6#"magrad mezareba"
    add(set1, vitom_mudmiva)
    print(set1)
